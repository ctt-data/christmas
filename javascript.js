...
$("#Nuremberg").click(function() {
  message =
    "Oh no!:/";
  $("#answer_text4").text(message);
});

$("#Dresden").click(function() {
  message =
    "Yes! Correct!:)";
  $("#answer_text5").text(message);
});

$("#Munich").click(function() {
  message =
    "Opps no!";
  $("#answer_text6").text(message);
});

$("#TheCityHall").click(function() {
  message =
    "Yayaya!";
  $("#answer_text7").text(message);
});

$("#St_Stephens_Cathedral").click(function() {
  message =
    "Oppsieee";
  $("#answer_text8").text(message);
});

$("#TheOperaHouse").click(function() {
  message =
    "Opps no!";
  $("#answer_text9").text(message);
});

$("#Turkey").click(function() {
  message =
    "Perfect!";
  $("#answer_text10").text(message);
});

$("#Greece").click(function() {
  message =
    "Wrong!";
  $("#answer_text11").text(message);
});
